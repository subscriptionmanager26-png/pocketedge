...
export default function ChallengeWelcomeCard({ className = '' }) {
  return (
    <div className={`pe-card p-6 sm:p-8 text-center ${className}`}>
      ...
      <h3 className="text-xl sm:text-2xl font-semibold text-neutral-900">{CHALLENGE_PRIZE_HEADLINE}</h3>
      <p className="text-neutral-600 mt-2 text-sm sm:text-base leading-relaxed max-w-md mx-auto">
        {CHALLENGE_BASKETS_HINT}
      </p>
      <p className="inline-flex items-center justify-center gap-2 mt-4 text-sm font-medium text-neutral-700 bg-neutral-100 rounded-full px-4 py-2">
