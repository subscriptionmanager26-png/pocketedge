      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {slots.map((basket, index) => {
              ...
              <div key={basket.id} className="pe-card p-4 flex flex-col h-full min-h-[148px]">
                ...
                <div className="flex gap-2 mt-4 pt-3 border-t border-pe-border/60">
                  <button
                    ...
                    className="flex-1 px-3 py-2 rounded-lg border border-pe-border/80 text-xs font-semibold text-neutral-700 hover:border-neutral-300 transition-colors"
                  >
                    View
                  </button>
                  <button
                    ...
                    className="flex-1 px-3 py-2 rounded-lg bg-neutral-900 text-xs font-semibold text-white hover:bg-neutral-800 transition-colors"
                  >
                    Edit
                  </button>
                </div>
          ...
          return (
            ...
            >
              <p className="text-[10px] font-semibold uppercase tracking-wider text-neutral-400 mb-3 w-full text-left">
                Slot {slotNumber}
              </p>
              <span className="w-10 h-10 rounded-full border-2 border-dashed border-neutral-300 flex items-center justify-center mb-2">
                <Plus className="w-5 h-5 text-neutral-500" aria-hidden />
              </span>
              <span className="text-sm font-semibold text-neutral-900">Add basket</span>
              <span className="text-xs text-neutral-500 mt-1">Fill this challenge slot</span>
            </button>
          );
        })}
      </div>
