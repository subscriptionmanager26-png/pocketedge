...
export default function BottomNav({ activeTab, onNavigate }) {
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-50 w-full bg-pe-canvas/95 backdrop-blur-xl border-t border-neutral-200/60 safe-area-pb">
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 flex-1 py-2 transition-colors ${
                active ? 'text-pe-text' : 'text-pe-text-secondary hover:text-pe-text'
              }`}
            >
