...
export const PORTFOLIO_UPDATES = {
  RELIANCE: [
    {
      ...
      summary: 'Brokerage previews point to improving ARPU and subscriber additions at Jio, supporting the consolidated earnings outlook for Reliance.',
    },
    {
      id: 'u_r2',
      type: 'post',
  ...
  HDFCBANK: [
    ...
    },
    {
      ...
      summary: 'Early Q1 previews suggest net interest margins held steady for large private banks despite deposit repricing pressures.',
    },
    {
      id: 'u_h3',
      type: 'buy',
  ...
  ICICIBANK: [
    {
      ...
      summary: 'Retail loan growth continued to outpace the sector average, with management highlighting healthy asset quality trends.',
    },
    {
      id: 'u_i2',
      type: 'post',
  ...
  TCS: [
    ...
    },
    {
      ...
      summary: 'Large deal momentum remained intact in the quarter, though firms guided cautiously on margins amid wage and subcontracting costs.',
    },
  ],
  INFY: [
    {
  ...
  WIPRO: [
    {
      ...
      summary: 'Management emphasized building a larger-deal pipeline in the Americas while prioritizing margin improvement over aggressive growth.',
    },
  ],
  IRCTC: [
    {
...
/** Metrics for Portfolio tab — live uses value; watchlists are weight + 1D % only. */
