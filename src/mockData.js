...
export const featuredBaskets = [
  {
    name: 'US Tech Giants',
    description: 'Invest in leading American technology companies',
    return: '+24.5%',
  ...
  {
    name: 'Global EV Revolution',
    description: 'Electric vehicle manufacturers and suppliers worldwide',
    return: '+18.2%',
    assets: ['TSLA', 'NIO', 'RIVN', 'LI', 'LCID'],
    minInvestment: '₹5,000',
  },
  {
    name: "Trump's Tots",
    description: 'Strategic investments aligned with policy shifts',
    return: '+32.8%',
    assets: ['DJT', 'TSLA', 'BA', 'XOM', 'LMT'],
    minInvestment: '₹5,000',
  },
];
