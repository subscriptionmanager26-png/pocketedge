-- Indices join social_market_assets (asset_type = 'index') so Markets can
-- serve fresh NSE levels from Postgres instead of the stale static JSON.
...
alter table public.social_market_assets
  ...
  check (asset_type in ('stock', 'etf', 'fund', 'commodity', 'bond', 'index'));
