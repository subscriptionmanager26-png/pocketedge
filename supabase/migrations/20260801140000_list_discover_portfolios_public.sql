-- Public Ideas hub: allow logged-out discover of public portfolio payloads.
-- Day return is derived client-side from redacted holdings changePct × weight.
...
revoke all on function public.list_discover_portfolios(text, int, int) from public;
grant execute on function public.list_discover_portfolios(text, int, int) to anon, authenticated;
