-- Include fund NAV date in enriched portfolio holdings so FE Day's PnL
-- attribution (D -> D+1) can evaluate immediately without waiting for a
-- follow-up market lookup.
