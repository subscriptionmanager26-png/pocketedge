-- Include watchlist portfolios in asset Holders (AMC scheme books, etc.).
-- Previously watchlists were excluded and holdings required qty > 0, which
-- hid AMC users seeded as kind='watchlist' with weightPct-only holdings.
