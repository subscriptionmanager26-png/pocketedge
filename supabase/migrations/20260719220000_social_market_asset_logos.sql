-- Return logo URLs from social market RPCs so the UI can prefer logo_icon_url.
...
as $$
  ...
  select json_build_object(
    ...
    'logo_url', a.logo_url, 'logo_icon_url', a.logo_icon_url
  )
  ...
  if p_asset_type = 'fund' then
    ...
    from (
      select a.asset_type, a.asset_key, a.name, a.price, a.change_pct,
        ...
        a.exchange, a.exchange_symbol, a.isin, a.logo_url, a.logo_icon_url
      from public.social_market_assets a
