-- MCX commodities: pg_cron → Supabase edge → Cloudflare Browser Rendering proxy.
-- Direct MCX fetch is blocked from Supabase/Vercel/plain CF Workers (WAF 403).
-- Proxy token is stored in social_market_job_config (job_name = mcx-cf-proxy).
